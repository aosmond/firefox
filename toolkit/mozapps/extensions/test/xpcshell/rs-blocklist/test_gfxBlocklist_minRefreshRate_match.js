...
async function run_test() {
  ...
  switch (Services.appinfo.OS) {
    case "WINNT":
      gfxInfo.spoofMonitorInfo(3, 90, 120);
      break;
    case "Linux":
      gfxInfo.spoofMonitorInfo(2, 40, 60);
      break;
    case "Darwin":
      gfxInfo.spoofMonitorInfo(3, 30, 31);
      break;
    case "Android":
      gfxInfo.spoofMonitorInfo(1, 50, 120);
      break;
  }
  ...
  mockGfxBlocklistItemsFromDisk(
    "../data/test_gfxBlocklist_minRefreshRate.json"
  );
}
