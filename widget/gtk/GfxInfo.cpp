  ...
  *aStatus = nsIGfxInfo::FEATURE_STATUS_UNKNOWN;
  ...
  const struct {
    ...
    nsCString mFailureId;
      ...
      {nsIGfxInfo::FEATURE_H264_HW_DECODE, CODEC_HW_DEC_H264, "FEATURE_FAILURE_VIDEO_DECODING_MISSING"_ns},
      {nsIGfxInfo::FEATURE_H264_HW_ENCODE, CODEC_HW_ENC_H264, "FEATURE_FAILURE_VIDEO_ENCODING_MISSING"_ns},
      {nsIGfxInfo::FEATURE_VP8_HW_DECODE, CODEC_HW_DEC_VP8, "FEATURE_FAILURE_VIDEO_DECODING_MISSING"_ns},
      {nsIGfxInfo::FEATURE_VP8_HW_ENCODE, CODEC_HW_ENC_VP8, "FEATURE_FAILURE_VIDEO_ENCODING_MISSING"_ns},
      {nsIGfxInfo::FEATURE_VP9_HW_DECODE, CODEC_HW_DEC_VP9, "FEATURE_FAILURE_VIDEO_DECODING_MISSING"_ns},
      {nsIGfxInfo::FEATURE_VP9_HW_ENCODE, CODEC_HW_ENC_VP9, "FEATURE_FAILURE_VIDEO_ENCODING_MISSING"_ns},
      {nsIGfxInfo::FEATURE_AV1_HW_DECODE, CODEC_HW_DEC_AV1, "FEATURE_FAILURE_VIDEO_DECODING_MISSING"_ns},
      {nsIGfxInfo::FEATURE_AV1_HW_ENCODE, CODEC_HW_ENC_AV1, "FEATURE_FAILURE_VIDEO_ENCODING_MISSING"_ns},
      {nsIGfxInfo::FEATURE_HEVC_HW_DECODE, CODEC_HW_DEC_HEVC, "FEATURE_FAILURE_VIDEO_DECODING_MISSING"_ns},
      {nsIGfxInfo::FEATURE_HEVC_HW_ENCODE, CODEC_HW_ENC_HEVC, "FEATURE_FAILURE_VIDEO_ENCODING_MISSING"_ns}};
