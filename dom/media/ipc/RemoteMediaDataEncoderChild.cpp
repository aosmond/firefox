...
RefPtr<PRemoteEncoderChild::ConstructPromise>
RemoteMediaDataEncoderChild::SendConstruct() {
  {
    MutexAutoLock lock(mMutex);
    mHasActor = CanSend();
  }

  return PRemoteEncoderChild::SendConstruct();
}
...
RefPtr<GenericPromise> RemoteMediaDataEncoderChild::SetBitrate(
  ...
  RefPtr<RemoteMediaDataEncoderChild> self = this;
  return InvokeAsync(
      mThread, __func__, [self, aBitsPerSec]() -> RefPtr<GenericPromise> {
